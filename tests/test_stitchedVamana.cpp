/* contains the unit tests for files: stitchedVamana.cpp, stitchedVamanaParallel.cpp */
...
// stitchedVamanaParallel test is the same as stitchedVamana test
TEST_CASE("stitchedVamanaParallel function test")
{
    vector<vector<double>> coords = {
        {0, 1.0, 2.0, 3.0},
        {1, 4.0, 5.0, 6.0},
    ...
    Graph G = stitchedVamanaParallel(coords, F, a, L_small, R_small, R_stitched, medoids);
